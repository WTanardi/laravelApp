	...
	<div class="container">
		...
		<div class="category">
			<div class="category-item" href="/jelajahi/alam">
				<img src="images/KebunBibitWonorejo1.jpg" alt="Kategori 1" >
        <a  href="/jelajahi/alam" style="text-decoration: none;  justify-content:center;"> <h3> Alam</h3></a>
        <p>Taman Bungkul, ...</p>
			</div>
			<div class="category-item">
				<img src="images/KebunBibitWonorejo1.jpg" alt="Kategori 2">
				<a  href="/jelajahi/budaya" style="text-decoration: none;"> <h3> Budaya</h3></a>
				<p>Lorem ipsum ....</p>
			</div>
			<div class="category-item">
				<img src="images/KebunBibitWonorejo1.jpg" alt="Kategori 3">
